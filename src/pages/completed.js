...
import { LuCircleCheck, LuHouse, LuInfo } from "react-icons/lu";
...
const Completed = () => {
    ...
    const fetchOrders = async () => {
        try {
            setLoading(true);
            const response = await fetch(`${getBaseURL()}/orders/paid`);
    ...
    return (
        <Layout>
            ...
            <Alert
                icon={<LuInfo />}
                message="Pesanan Anda telah berhasil diproses dan siap digunakan. Terima kasih telah memilih layanan kami!"
                bgColor="#5395FF"
            />
